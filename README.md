...
- **[여기서 Qt5 정상구동 프로젝트 다운로드](https://github.com/nebobyeoli/Miniscope-DAQ-QT-Software-Escope/commit/7a9e3cf7ddf1bce497611335fac3e3ab71640556.zip)** [`(Commit 7a9e3cf)`](https://github.com/nebobyeoli/Miniscope-DAQ-QT-Software-Escope/commit/7a9e3cf7ddf1bce497611335fac3e3ab71640556)
- 이 브랜치의 이후 수정 내역에는 오류 재구현하는 테스트 코드도 포함되어 있어, 레포지토리 다운로드 기능으로 그냥 설치하면 구동 시 화면이 제대로 안 나올 수 있음
